...
const popularOperators: Operator[] = [
    { id: 'hathway', name: 'Hathway Digital', icon: 'television-classic', requiresCircle: true },
    { id: 'siti', name: 'Siti Cable', icon: 'television-guide', requiresCircle: false },
    { id: 'den', name: 'DEN Networks', icon: 'television-play', requiresCircle: true },
    { id: 'gtpl', name: 'GTPL', icon: 'television', requiresCircle: false },
    { id: 'asianet', name: 'Asianet', icon: 'monitor-share', requiresCircle: false },
    { id: 'local', name: 'Local Cable', icon: 'remote', requiresCircle: true },
];

const allOperators = [
    ...popularOperators,
    { id: 'act', name: 'ACT Digital TV', icon: 'television-box', requiresCircle: false },
    { id: 'tata', name: 'Tata Play Fiber', icon: 'television-classic', requiresCircle: false },
    { id: 'tikona', name: 'Tikona', icon: 'television-guide', requiresCircle: false },
];
...
export default function CableTVScreen() {
    ...
    const validateForm = () => {
        if (!selectedOperator || subscriberId.length < 6) return false;
        if (selectedOperator.requiresCircle && !selectedCircle) return false;
        return true;
    };
        ...
        if (selectedPaymentMode === 'Wallet') {
            router.push({
                ...
                params: {
                    ...
                    loanAccountNumber: billData?.subscriberId,
    ...
    const filteredOperators = useMemo(() => 
        allOperators.filter(o => o.name.toLowerCase().includes(operatorSearchQuery.toLowerCase())),
    [operatorSearchQuery]);
            ...
            <SafeAreaView style={styles.safeArea}>
                <View style={styles.header}>
                    ...
                    <View style={styles.headerCenter}>
                        <Text style={styles.headerTitle}>Cable TV Bill</Text>
                        <Text style={styles.headerSubtitle}>Pay your monthly cable bill</Text>
                    </View>
                ...
                <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={{ flex: 1 }}>
                    <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled" contentContainerStyle={styles.scrollContent}>
                        ...
                        {!billData ? (
                            <>
                                <Text style={styles.sectionTitle}>Select Cable Provider</Text>
                                ...
                                <View style={styles.formCard}>
                                    <View style={styles.fieldGroup}>
                                        ...
                                        <View style={styles.inputContainer}>
                                            <MaterialCommunityIcons name="smart-card-outline" size={18} color="#94A3B8" />
                                            <TextInput
                                                style={styles.input}
                                    ...
                                    {selectedOperator?.requiresCircle && (
                                        <View style={[styles.fieldGroup, { marginTop: 15 }]}>
                                            <Text style={styles.fieldLabel}>City / Circle *</Text>
                                            <TouchableOpacity style={styles.inputContainer} onPress={() => setShowCircleModal(true)}>
                                                <Ionicons name="location-outline" size={18} color="#94A3B8" />
                                                <Text style={styles.input}>{selectedCircle || 'Select City'}</Text>
                                    ...
                                    {selectedOperator && (
                                        <View style={[styles.fieldGroup, { marginTop: 15 }]}>
                                            ...
                                            <View style={[styles.inputContainer, { backgroundColor: '#F1F5F9' }]}>
                                                <MaterialCommunityIcons name="television-classic" size={18} color="#0D47A1" />
                            ...
                            <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }] }}>
                                <View style={styles.formCard}>
                                    <View style={styles.detailsHeader}>
                                        <Text style={styles.sectionTitleSmall}>Connection Summary</Text>
                                    ...
                                    <View style={styles.detailRow}>
                                        ...
                                        <Text style={styles.detailValue}>{billData.subscriberId}</Text>
                                    </View>
                                    <View style={styles.detailRow}>
                                    ...
                                    <View style={[styles.detailRow, { borderBottomWidth: 0 }]}>
                                        ...
                                        <Text style={[styles.detailValue, { flex: 1, textAlign: 'right' }]} numberOfLines={1}>{billData.billingAddress}</Text>
                                    </View>
                                </View>
                                ...
                                <TouchableOpacity style={styles.confirmRow} onPress={() => setIsConfirmed(!isConfirmed)}>
                                    ...
                                    <Text style={styles.confirmText}>I confirm the subscriber details & want to proceed with payment.</Text>
                                </TouchableOpacity>
                    ...
                    <View style={styles.modalOverlay}>
                        <View style={styles.modalContent}>
                            <View style={styles.modalHeader}>
                                <Text style={styles.modalTitle}>Select Cable Provider</Text>
                ...
                <Modal visible={showCircleModal} transparent animationType="slide" onRequestClose={() => setShowCircleModal(false)}>
                    <View style={styles.modalOverlay}>
                        <View style={styles.modalContent}>
                            <View style={styles.modalHeader}>
                                <Text style={styles.modalTitle}>Select City / Circle</Text>

...
export default function ElectricityBillScreen() {
    ...
    const [billDetails, setBillDetails] = useState<ElectricityBillDetails | null>(null);
            ...
            <SafeAreaView style={styles.safeArea}>
                ...
                <View style={styles.header}>
                    ...
                    <View style={styles.headerCenter}>
                        ...
                        <Text style={styles.headerSubtitle}>Pay your electricity bill securely</Text>
                    </View>
                                ...
                                <>
                                    ...
                                    <View style={styles.browseContainer}>
                                        <TouchableOpacity style={styles.browseButton} onPress={() => setShowBoardModal(true)}>
                                            <Text style={styles.browseText}>View All Electricity Boards</Text>
                                    ...
                                    <View style={styles.formCard}>
                                        {selectedBoard ? (
                                            <View style={styles.fieldGroup}>
                                                <Text style={styles.fieldLabel}>Selected Electricity Board</Text>
                                        ...
                                        <View style={styles.fieldGroup}>
                                            <Text style={styles.fieldLabel}>Consumer Number / CA Number *</Text>
                                        ...
                                        <View style={styles.fieldGroup}>
                                            <Text style={styles.fieldLabel}>Area / Unit (if required)</Text>
                                            <View style={styles.inputContainer}>
                                                <Ionicons name="location-outline" size={16} color="#94A3B8" />
                                                <TextInput
                                                    style={styles.input}
                                                    placeholder="Enter Area or Unit Name"
                                                    placeholderTextColor="#94A3B8"
                                                    value={area}
                                ...
                                <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }] }}>
                                    ...
                                    <View style={styles.summaryCard}>
                                        <View style={styles.summaryHeader}>
                                            <Ionicons name="flash" size={24} color="#0D47A1" />
                                        ...
                                        <View style={styles.summaryRow}>
                                            <Text style={styles.summaryLabel}>Consumer ID</Text>
                                        ...
                                        <View style={styles.summaryRow}>
                                            ...
                                            <Text style={styles.summaryValue}>{billDetails.electricityUsage}</Text>
                                        </View>
                                        <View style={styles.summaryRow}>
                                    ...
                                    <TouchableOpacity style={styles.declarationRow} onPress={() => setIsConfirmed(!isConfirmed)}>
                                        ...
                                        <Text style={styles.declarationText}>I confirm that the above details are correct and authorize this electricity bill payment.</Text>
                                    </TouchableOpacity>
                    ...
                    <View style={styles.successOverlay}>
                        <View style={styles.successCard}>
                            ...
                            <View style={styles.receipt}>
                                <View style={styles.receiptRow}><Text style={styles.receiptLabel}>Transaction ID</Text><Text style={styles.receiptValue}>TX-ELE-{Math.floor(Math.random() * 900000) + 100000}</Text></View>
